...
class TestAnimalView(TestCase):
    ...
    def test_animal_post(self):
        ...
        # create animal
        post_response = self.client.post("/api/animals/",
                                         self.animal_data,
                                         format="json")
        ...
        post_response_2 = self.client.post("/api/animals/",
                                           self.animal_data_2,
                                           format="json")
        ...
        post_response_3 = self.client.post("/api/animals/",
                                           self.animal_data_4,
                                           format="json")
        self.assertDictEqual(post_response.json()["group"],
                             post_response_3.json()["group"])
